  ...
  const DashboardScreen = () => (
    <ScrollView style={styles.dashboard}>
      ...
      <View style={styles.navContainer}>
        ...
        <TouchableOpacity
          style={styles.navButton}
          onPress={() => Alert.alert('Assessments', 'Navigate to Assessments Screen')}
        >
        ...
        <TouchableOpacity
          style={styles.navButton}
          onPress={() => Alert.alert('Sites', 'Navigate to Sites Screen')}
        >
      ...
      <View style={styles.featuresContainer}>
        ...
        <TouchableOpacity
          ...
          onPress={() => Alert.alert('Text Report', 'Text reporting functionality ready!')}
        >
        ...
        <TouchableOpacity
          style={styles.featureButton}
          onPress={() => Alert.alert('Voice Report', 'Voice recording functionality ready!')}
        >
        ...
        <TouchableOpacity
          style={styles.featureButton}
          onPress={() => Alert.alert('Image Report', 'Camera functionality ready!')}
        >
        ...
        <TouchableOpacity
          style={styles.featureButton}
          onPress={() => Alert.alert('Site Update', 'GPS-based site updates ready!')}
        >
